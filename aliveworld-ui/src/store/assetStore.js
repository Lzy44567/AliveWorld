...
export const assetStore = reactive({
  ...
  makeGlobalAssets(names, metadata, defaultTag, defaultDescription) {
    ...
    return names.map(name => {
      ...
      return { name, tags, system_tags: meta.system_tags || [], desc: meta.description || defaultDescription, portrait: meta.portrait || null, is_template: Boolean(meta.is_template) };
    });
  },
