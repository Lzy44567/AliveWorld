...
@router.post("/{session_id}/causal-ledger/{influence_id}/restore")
def restore_influence(session_id: str, influence_id: str):
    game = _game(session_id)
    influence = game.undercurrent.causal_ledger.restore(influence_id)
    if not influence:
