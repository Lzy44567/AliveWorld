...
6. 只能使用 add_entry、update_entry、deactivate_entry、request_delete。不得请求文件、路径、代码或其他资产操作。
...
严格输出 JSON：
{
  "message": "给玩家看的自然语言解释",
  "operations": [
    {"op":"add_entry","entry":{"name":"名称","keys":"可选关键词","content":"内容","tags":["AI推断"]},"creates_axiom":false},
